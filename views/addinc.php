...
<body>
        ...
        <?php include '../includes/topbar.php';?>
            ...
            <ol class="breadcrumb">
                <li class="active text-success"><i class="fa fa-minus mr-1"></i>/ Income Account</li>
            </ol>

        <div class="card shadow">
            <div>
                <h6 class="list-group-item active"><i class="fa fa-minus mr-1"></i>/ Add Income</h6>
            </div>
            <div class="card-body">
                    <?php 
                        $modal = new Modal;
                ...
                <form action="#" method="POST" class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary" name="income">Add Income</button>
                </form>
            </div>
        </div>
