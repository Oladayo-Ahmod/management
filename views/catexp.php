...
<body>
                ...
                <div>
                    <h6 class="list-group-item active"><i class="fa fa-minus mr-1"></i>/ Expenditure Category</h6>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="display:flex;">
                                        <a href="catedit.php?ecid=<?=$rows['id'];?>"><i class="fas fa-pen mr-2 text-primary"></i></a>
                                        <a href="delete.php?ecid=<?=$rows['id'];?>"><i class="fas fa-trash text-danger"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                                    <?php } ?>
                                     ...
                                     <form class="form-group" enctype="multipart/form-data" method="POST" action="">
										<label for="page">Category Name</label>
											<input type="text" name="cat-name" placeholder="category name" required class="form-control"><br>
                                                <button type="submit" name="catexp" class="btn btn-primary">Add</button>
                                    </form>
                                    </div>
