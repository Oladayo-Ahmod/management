...
<head>
    ...
    <title>Admin | Budget | Income</title>
     <!-- css file -->
...
<body>
                ...
                <div>
                    <h6 class="list-group-item active"><i class="fa fa-minus mr-1"></i>/ Budgeted income</h6>
                </div>
                <div class="card-body">
                                        ...
                                        foreach($row as $rows){?>
                                            <tr>
                                                ...
                                                <td style="display:flex;">
                                                    <a href="budgetedit.php?ibid=<?=$rows['id'];?>"><button class="btn btn-primary mr-2">Edit</button></a>
                                                    <a href="delete.php?ibid=<?=$rows['id'];?>"><button class="btn btn-danger">Delete</button></a>
                                                </td>
                                            </tr>
                                                <?php }}?>                               
                            </tbody>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
                                     <form class="form-group" enctype="multipart/form-data" method="POST" action="">
                                        ...
                                        <button type="submit" name="budgetinc" class="btn btn-primary">Add</button>
                                    </form>
                                    </div>
